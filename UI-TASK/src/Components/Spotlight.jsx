    ...
    <div className="flex justify-center items-center mt-14 flex-col gap-16 w-full py-14 px-16 bg-[#fafafa]">
      <div className="flex justify-between w-full items-center">
        <span className="flex flex-col gap-2">
          <h1 className="bg-gradient-to-r pb-2 from-[#a572b6] via-purple-700 to-blue-800 bg-clip-text text-5xl font-medium tracking-tight text-transparent">In The Spotlight</h1>
